...
if isempty(General.scale)
  General.scale='denormalized';%%%%General.scale
end
...
for i=1:n,                         % main loop
  ...
  set(h_label,'Visible','on','verticalalignment','top','Fontname', 'Times New Roman');
...
set(h_label,'interpreter','tex','Fontname', 'Times New Roman');

h_colorbar=som_recolorbar('all',5, General.scale);   %refresh colorbars$$$$$$$$$$$
